...
class _$_RegisterModel implements _RegisterModel {
  const _$_RegisterModel(
      {this.name, this.email, this.password, this.age, this.avatar});
  ...
  @override
  String toString() {
    return 'RegisterModel(name: $name, email: $email, password: $password, age: $age, avatar: $avatar)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, name, email, password, age, avatar);
...
abstract class _RegisterModel implements RegisterModel {
  const factory _RegisterModel(
      ...
      final String? password,
      final int? age,
      final String? avatar}) = _$_RegisterModel;
