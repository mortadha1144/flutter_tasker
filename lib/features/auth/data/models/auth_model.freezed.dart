...
abstract class $AuthModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({@JsonKey(name: 'user') UserModel? userModel, String? token});
...
class _$_AuthModel implements _AuthModel {
  const _$_AuthModel({@JsonKey(name: 'user') this.userModel, this.token});
  ...
  @override
  String toString() {
    return 'AuthModel(userModel: $userModel, token: $token)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, userModel, token);
...
abstract class _AuthModel implements AuthModel {
  const factory _AuthModel(
      {@JsonKey(name: 'user') final UserModel? userModel,
